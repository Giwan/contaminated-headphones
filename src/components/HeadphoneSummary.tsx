...
export const HeadphoneSummary = (props: HeadphoneSummaryProps) => (
  <div class="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
    <div>
      <div class="flex items-center gap-6 mb-8">
        ...
        <button
          ...
          class={cn(
            ...
            props.copied ? 'text-emerald-600' : 'text-slate-400 hover:text-slate-900'
          )}
        >
      ...
      <p class="text-4xl font-black text-slate-200 tracking-tighter">{props.headphone.model}</p>
    ...
    >
      ...
      <span class="text-5xl font-black capitalize tracking-tighter">{props.headphone.totalRating}</span>
    </div>
  </div>
);
